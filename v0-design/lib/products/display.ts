...
export interface ProductDisplay {
  ...
  // SEO 個別最適化用（STORES 旧サイトとの重複回避・工房直販訴求）
  // 設定された商品は generateMetadata でこちらを優先採用する。
...
const DISPLAY: Record<string, ProductDisplay> = {
  ...
  gaston: {
    ...
    seoTitle: "【工房直販】Gaston ガストン｜横型アイアン手すり 極太32φ 鎚目仕上げ｜IRONWORKS ado",
    seoDescription: "鍛冶職人がハンマー鍛造で仕上げる極太32φ無垢丸鉄の横型アイアン手すり。ado 工房から直販・中間マージン無し。¥150,000〜。圧倒的な太さと鎚目の陰影が魅力。サイズオーダー対応・全国配送。",
  },
  claude: {
    slug: "claude",
    nameEn: "Claude",
    ...
    subtitle: "壁付け手すり・縦型 25φ",
    shortDescription: "鍛冶職人制作 縦型アイアン手すり 25φ マットブラック",
    longDescription:
      "艶消し黒で仕上げたシックな印象の壁付け手すり。デザイナー住宅のようなコンクリート住宅から和風建築まで、空間を選ばずよく馴染みます。白をご希望の場合は、同仕様・艶消し白仕上げの「カトリーヌ」をご用意しています。\n\n仕上がりの美しさ、使いやすさにこだわり、目立たない細かな部分も手をぬかず、長く愛用していただけるよう丁寧に制作しております。\n\n手すりは毎日手に触れ、安全のために付けるもの。握りやすく安心して掴める強度を考え、25φ（単2電池より少し細いくらい）のしっかりした太さで作っています。16φ や 19φ では、手すりとしては不安を感じる細さです（一般的な大人の人差し指が 16φ、親指が 19φ ほど）。\n\n住まいづくりの中で手すりはこだわる優先度が低いものかもしれませんが、『丁寧に作られた』アイアン手すりのある空間は全体を引き締め、毎日を上質で豊かにしてくれます。\n\n角やひっかかる危ない箇所がないよう丁寧に仕上げておりますので、小さなお子様がいるご家庭でも安心してお使いいただけます。これから毎日お使いいただく方の心豊かな暮らしを思い、制作しております。\n\n※写真の手すりは長さ 60cm のものとなります。\n※長さ 1100mm 以上の縦型手すりに関しては、最大座金間を 900mm に設定しております。",
    specs: [
      { label: "タイプ", value: "丸棒（パイプ材）" },
      { label: "素材", value: "鉄" },
      { label: "仕上げ", value: "錆止め吹付塗装 + 2液型ウレタン艶消し黒塗装" },
      { label: "カラー", value: "マットブラック（白は同仕様の「カトリーヌ」）" },
      { label: "太さ", value: "25φ" },
      { label: "サイズ", value: "D65×W55mm / ブラケット座金 35×55mm" },
      { label: "付属品", value: "取付用ビス M4×40mm（座金1箇所×2本）・タッチアップ剤" },
    ],
    featureBullets: FB_STKM_URETHANE,
    galleryIds: [
  ...
  catherine: {
    ...
    breadcrumbCategory: "縦型手すり",
    subtitle: "壁付け手すり・縦型 25φ",
    shortDescription: "鍛冶職人制作 縦型アイアン手すり 25φ マットホワイト",
    longDescription:
      "艶消し白で仕上げたシックな印象の壁付け手すり。デザイナー住宅のようなコンクリート住宅から和風建築まで、空間を選ばずよく馴染みます。黒をご希望の場合は、同仕様・艶消し黒仕上げの「クロード」をご用意しています。\n\n仕上がりの美しさ、使いやすさにこだわり、目立たない細かな部分も手をぬかず、長く愛用していただけるよう丁寧に制作しております。\n\n手すりは毎日手に触れ、安全のために付けるもの。握りやすく安心して掴める強度を考え、25φ（単2電池より少し細いくらい）のしっかりした太さで作っています。16φ や 19φ では、手すりとしては不安を感じる細さです（一般的な大人の人差し指が 16φ、親指が 19φ ほど）。\n\n住まいづくりの中で手すりはこだわる優先度が低いものかもしれませんが、『丁寧に作られた』アイアン手すりのある空間は全体を引き締め、毎日を上質で豊かにしてくれます。\n\n角やひっかかる危ない箇所がないよう丁寧に仕上げておりますので、小さなお子様がいるご家庭でも安心してお使いいただけます。これから毎日お使いいただく方の心豊かな暮らしを思い、制作しております。\n\n※写真の手すりは長さ 60cm のものとなります。\n※長さ 1100mm 以上の縦型手すりに関しては、座金間を 900mm に設定しております。",
    specs: [
      { label: "タイプ", value: "丸棒（パイプ材）" },
      { label: "素材", value: "鉄" },
      { label: "仕上げ", value: "錆止め吹付塗装 + 2液型ウレタン艶消し白塗装" },
      { label: "カラー", value: "マットホワイト（黒は同仕様の「クロード」）" },
      { label: "太さ", value: "25φ" },
      { label: "サイズ", value: "D65×W55mm / ブラケット座金 35×55mm" },
      { label: "付属品", value: "取付用ビス M4×40mm（座金1箇所×2本）・タッチアップ剤" },
    ],
  ...
  alexandre: {
    ...
    nameJaShort: "アレクサンドル",
    breadcrumbCategory: "縦型手すり",
    subtitle: "壁付け手すり・縦型 太径 31.8φ",
    shortDescription: "太径 31.8φ 縦型アイアン手すり マットブラック／マットホワイト（床〜天井ロング対応）",
    longDescription:
      "艶消し黒で仕上げたシックな印象の壁付け手すり。デザイナー住宅のようなコンクリート住宅から和風建築まで、空間を選ばずよく馴染みます。艶消し白の仕上げにも対応可能です。\n\nサイズオーダーが可能で、床から天井までのロング手すりとして、住宅設計に合わせて制作もいたします。\n\n手すりは毎日手に触れ、安全のために付けるもの。握りやすく安心して掴める強度を考え、31.8φ のしっかりした太さで作っています。16φ や 19φ では、手すりとしては不安を感じる細さです。玄関やトイレなど、立ち上がる時に体重をぐっと支えるためには、握りやすい太さのある手すりが安心です（一般的な大人の人差し指が 16φ、親指が 19φ ほど）。太い 31.8φ の手すりは、手の平いっぱいにギュッと握れる安心感があります。\n\n取り付け座金は手すりが太い分、スッキリ見えるようシャープなデザインにしております。\n\n住まいづくりの中で手すりはこだわる優先度が低いものかもしれませんが、『丁寧に作られた』アイアン手すりのある空間は全体を引き締め、毎日を上質で豊かにしてくれます。\n\n角やひっかかる危ない箇所がないよう丁寧に仕上げておりますので、小さなお子様がいるご家庭でも安心してお使いいただけます。これから毎日お使いいただく方の心豊かな暮らしを思い、制作しております。\n\n※写真の手すりは長さ 60cm のものです。長さはこのページで 1cm 単位でご指定いただけます。",
    specs: [
      { label: "タイプ", value: "STKM 31.8φ" },
      { label: "素材", value: "鉄" },
      { label: "仕上げ", value: "錆止め吹付塗装 + 2液型ウレタン艶消し黒塗装" },
      { label: "カラー", value: "マットブラック（艶消し白も対応可）" },
      { label: "太さ", value: "31.8φ（太径）" },
      { label: "サイズ", value: "L600 × D71.8 × W60mm / ブラケット座金 25×60mm" },
      { label: "備考", value: "全てハンドメイドのため多少の誤差あり / 床〜天井ロング対応" },
      { label: "付属品", value: "取付用ビス M4×40mm（座金1箇所×2本）・タッチアップ剤" },
    ],
    featureBullets: FB_STKM_URETHANE,
    galleryIds: [
  ...
  antoine: {
    ...
    nameJaShort: "アントワーヌ",
    breadcrumbCategory: "縦型手すり",
    subtitle: "壁付け手すり・縦型ロング 25φ・1.5〜3m",
    shortDescription: "鍛冶職人制作 縦型ロング手すり 25φ マットブラック／マットホワイト（1.5〜3m）",
    longDescription:
      "床から天井までのロング手すりを、住宅設計に合わせて制作いたします。サイズオーダー可能です。\n\nブラケットは A と B の 2 タイプをご用意いたしました。長さとブラケットのタイプは、このページでご指定いただけます。\n\n仕上がりの美しさ、使いやすさにこだわり、目立たない細かな部分も手をぬかず、長く愛用していただけるよう丁寧に制作しております。IRONWORKS ado は、傷や錆を鉄の味わいと謳ったり、不誠実なものづくりはいたしません。\n\n手すりは毎日手に触れ、安全のために付けるもの。握りやすく安心して掴める強度を考え、25φ（単2電池より少し細いくらい）のしっかりした太さで作っています。16φ や 19φ では、手すりとしては不安を感じる細さです（一般的な大人の人差し指が 16φ、親指が 19φ ほど）。\n\n住まいづくりの中で手すりはこだわる優先度が低いものかもしれませんが、『丁寧に作られた』アイアン手すりのある空間は全体を引き締め、毎日を上質で豊かにしてくれます。\n\n角やひっかかる危ない箇所がないよう丁寧に仕上げておりますので、小さなお子様がいるご家庭でも安心してお使いいただけます。これから毎日お使いいただく方の心豊かな暮らしを思い、制作しております。\n\nシックな印象の艶消し黒（マットブラック）仕上げと、明るく柔らかい印象の半艶消し白（マットホワイト）仕上げの 2 色をご用意いたしました。色はこのページでご指定いただけます。\n\n● 取付方法について\n専門業者に設置を依頼されることをお勧めいたします。ご自分で取り付ける場合は、設置場所にしっかりした下地があることを予めご確認のうえ、下地にビスでしっかりと固定してください。付属品のビスは木下地用ですので、コンクリート壁の場合は専用のビスをご用意ください。\n\n万が一、鋭利な物などがぶつかって塗装が剥がれてしまった場合は、そこから錆が発生する原因となるため、付属のタッチアップ剤で修復してください。",
    specs: [
      { label: "タイプ", value: "丸棒（パイプ材）" },
      { label: "素材", value: "鉄" },
      { label: "仕上げ", value: "錆止め吹付塗装 + 2液型ウレタン艶消し黒塗装" },
      { label: "カラー", value: "マットブラック（マットホワイトも対応可）" },
      { label: "サイズ", value: "1500〜3000mm（サイズオーダー可）" },
      { label: "手すり太さ", value: "25φ" },
      { label: "ブラケット座金", value: "A タイプ φ40 × 55mm / B タイプ φ25 × 60mm" },
      { label: "ブラケット出寸法", value: "D65 × H55mm" },
      { label: "付属品", value: "取付ビス M4 × 40mm（座金 1 箇所につき 2 本）・タッチアップ剤" },
    ],
    featureBullets: FB_STKM_URETHANE,
    // STORES アイテムページ (.../items/66c843839dd5030955588e20) から抽出した 20 枚
    // + マットホワイト仕上げイメージ (AI生成・実物の色違いバリエーション・2026-07-08 蠣﨑さん承認)
    galleryIds: [
      "2d1043dcd7658a96e5f3.jpg", "/images/gallery/antoine-color-white.jpg", "27028bc72ffa6bf103d8.jpg", "fbdf60c247bea8b3c486.jpg",
  ...
  scroll22: {
    ...
    nameJaShort: "スクロール",
    breadcrumbCategory: "ロートアイアン・縦型",
    subtitle: "ロートアイアン・縦型 22φ",
    shortDescription: "無垢鉄 22φ 80cm固定 ミツロウ仕上げ",
    longDescription:
      "くるっとした形がおしゃれな縦型のロートアイアン手すりです。\n\n魔法のステッキのような可愛らしい見た目とは裏腹に、無垢鉄を火造り鍛造した本格的な作りの逸品。鉄の工芸家が一つひとつ手仕事で丹念に、情熱をもって作り上げております。手すり全体を打ち残しなくハンマーで叩き、美しく鎚目の付けられた鉄は素材としても強さが増し、握り心地が良く、温かみも感じる仕上がりとなっております。\n\nこちらの手すりの太さは【22φ（直径 22mm）】、重量は約 2.8kg です。ズシッと安心感のある作り。さりげなく控えめな 16φ の手すりと比べると、圧倒的な存在感があります。こだわったインテリアにこそ取り入れていただきたい、本格的でおしゃれなロートアイアン手すりです。\n\n下側のエンド部分は少し細くすることで、野暮ったい印象にならないよう仕上げています。写真で見ただけでは尖って危なく感じる方もおられるかもしれませんが、先端は丸く危険のないように仕上げ、少し壁に向かわせるようにしております。\n\n● くるっとした部分は【右向き・左向き】をご指定いただけます。\n\n● 表面の仕上げ処理は『蜜蝋仕上げ』です。\n蜂の巣から取れるミツロウを、熱した状態の鉄の表面に溶かし付け（焦がし付ける感じ）表面をコーティングしています。触った感触は塗装のものと比べてしっとりとした感触です（ベタついてはおりません）。\n\n【なぜ塗装ではないのか？】\n塗装は錆への対策や仕上がりの均一性などの観点では、ミツロウなどの天然素材による仕上げに比べて優れていますが、どうしても表面は『塗料の色』になり、少し無機質な表情になりがちです。この手すりは、アナログな手仕事を経たからこそ生まれる鉄の美しい表情をできるだけ生かしてお届けしたい想いから、ミツロウで仕上げております。\n\nミツロウ仕上げの防錆についての補足ですが、（湿度の高くない）室内で一般的な使用方法であれば、完璧ではありませんが十分な錆止め効果はあります。雨風にさらされる屋外や、常に直射日光が当たるような場所での使用はおすすめできません。\n\n仕上げや長さの変更をご希望の際はお問い合わせください。\n\n取り付けビスが付属します（ステンレス製タッピングビス M5-40 × 4本）。",
    specs: [
      ...
      { label: "太さ", value: "22φ（重量 約 2.8kg）" },
      { label: "向き", value: "右向き・左向き 選択可（同価格）" },
      { label: "付属品", value: "ステンレス製タッピングビス M5-40 × 4本" },
      { label: "用途", value: "湿度の高くない屋内推奨（屋外・直射日光は不可）" },
    ],
    featureBullets: FB_MITSUROU,
    galleryIds: [
  ...
  fabrice: {
    ...
    nameJaShort: "ファブリス",
    breadcrumbCategory: "ロートアイアン・縦型",
    subtitle: "ロートアイアン・縦型 火造り鍛造",
    shortDescription: "無垢鉄 火造り鍛造 サイズオーダー対応",
    longDescription:
      "鉄の無垢材を火に入れ赤くなるまで熱し、西洋鍛冶師による「手」と「熟練の感覚」で叩き形成していきます。ロートアイアン（日本語で『鍛鉄』といいます）という技術で造られているからこそ生み出せる、美しく、力強く、あたたかみのある手すり。\n\n洋風住宅はもちろんのこと、和風建築にもよく合います。サイズオーダー可能です。\n\n住まいづくりの中で手すりはこだわる優先度が低いものかもしれませんが、『丁寧に作られた』アイアン手すりのある空間は全体を引き締め、毎日を上質で豊かにしてくれます。\n\n角やひっかかる危ない箇所がないよう丁寧に仕上げておりますので、小さなお子様がいるご家庭でも安心してお使いいただけます。これから毎日お使いいただく方の心豊かな暮らしを思い、制作しております。\n\nサイズオーダーをご希望の場合はお問い合わせください。",
    specs: [
      { label: "タイプ", value: "丸棒 φ20〜35mm（無垢鉄）" },
      { label: "素材", value: "鉄" },
      { label: "仕上げ", value: "錆止め吹付塗装 + 2液型ウレタン艶消し黒塗装" },
      { label: "製法", value: "火造り鍛造（手打ち）" },
      { label: "サイズ", value: "L800 × D65 × W55mm / ブラケット座金 φ40×55mm" },
  ...
  tsuchime: {
    ...
    nameJaShort: "鎚目",
    breadcrumbCategory: "ロートアイアン・縦型",
    subtitle: "ロートアイアン・縦型 火造り鍛造 鎚目",
    shortDescription: "無垢鉄 火造り鍛造 鎚目フラットバー サイズオーダー対応",
    longDescription:
