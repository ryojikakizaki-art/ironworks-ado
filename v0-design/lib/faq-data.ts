...
export const SITE_FAQS: FaqItem[] = [
  ...
  {
    q: "色や仕上げは選べますか？",
    a: "標準ではマットブラック / マットホワイトの 2 色をご用意しています。同じ形状で黒・白それぞれ別の商品としてご用意している場合（例：クロード⇔カトリーヌ、ルネ⇔クレール）は、白をご希望であれば白側の商品をそのままご注文いただくのが正しい選び方です（黒い商品を白く塗り替える特注ではありません）。アレクサンドル・アントワーヌは同じ商品ページ内で白仕上げを選択いただけます（合計 +15%）。それ以外の色（焼付塗装によるカラーオーダー、溶融亜鉛めっき、無塗装の黒皮蜜蝋仕上げなど）は特注対応となりますので、お問い合わせください。屋外設置の場合は溶融亜鉛めっき + 焼付塗装の二重防錆をおすすめしています。",
  },
  {
    q: "メンテナンスは必要ですか？",
