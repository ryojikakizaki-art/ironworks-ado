...
const tradeFaqs = [
  ...
  {
    q: "塗装なしで納品してもらえますか？",
    a: "可能です。マットブラック / マットホワイトの塗装仕上げの商品は、塗装をしない鉄の素地のまま（防錆油も塗らない状態）での納品も承ります。価格は一般小売価格から 10% お値引きします（例：アントワーヌ L1500mm ¥56,000 → ¥50,400）。建物に合わせて現場で塗装される場合などにご利用ください。\n※ 素地の鉄は保管・輸送中に表面へ薄く錆が出ることがあります。塗装前の下地処理（錆落とし・脱脂）は現場側でお願いします。塗装なしで納品した商品は、仕上げ・錆に関する保証の対象外です。",
  },
  {
    q: "支払い条件は？",
