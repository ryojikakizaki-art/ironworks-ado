  ...
  return (
    <section className="relative h-screen min-h-[760px] w-full overflow-hidden bg-dark">
      ...
      {/* ── 前景：上に ado ロゴ → 中央に見出し → 下に CTA ＋ 信頼 ──
          ...
          2026-07-02 タスク5-1: ドックがタブのみになり低くなったため pb を縮小。 */}
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-6 pt-20 md:pt-24 pb-32 md:pb-36">
